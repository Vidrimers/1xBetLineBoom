...
if (!TELEGRAM_BOT_TOKEN || !TELEGRAM_CHAT_ID) {
  console.error(
    "❌ Ошибка: TELEGRAM_BOT_TOKEN и TELEGRAM_CHAT_ID должны быть установлены в .env"
  );
  process.exit(1);
}
...
// Функция для отправки уведомления в основной чат (админ)
...
console.log("✅ Все функции бота готовы к использованию");
